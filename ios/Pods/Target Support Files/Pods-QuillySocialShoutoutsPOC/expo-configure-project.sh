...
with_node \
  ...
  --target "/Users/hwissotzky/Documents/vbox/quilly-social-shoutouts-poc/ios/Pods/Target Support Files/Pods-QuillySocialShoutoutsPOC/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-camera" "expo-constants" "expo-crypto" "expo-device" "expo-document-picker" "expo-file-system" "expo-font" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-screen-orientation" "expo-sharing" "expo-system-ui" "expo-web-browser"
